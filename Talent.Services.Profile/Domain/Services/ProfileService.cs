...
namespace Talent.Services.Profile.Domain.Services
{
    public class ProfileService : IProfileService
    {
        ...
        public async Task<bool> UpdateTalentProfile(TalentProfileViewModel model, string updaterId)
        {
            ...
            try
            {
                if (model.Id != null)
                {
                    ...
                    existingTalent.VisaExpiryDate = (DateTime)model.VisaExpiryDate;
        ...
        //public async Task<TalentProfileViewModel> UpdateTalentProfile(TalentProfileViewModel model, string updaterId) {
        ...
        protected ExperienceViewModel ViewModelFromExperiences(UserExperience experience)
        {
